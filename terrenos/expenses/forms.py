...
class ExpenseForm(forms.ModelForm):
    class Meta:
        model = Expense
        fields = ['project', 'date', 'type', 'detail', 'amount', 'currency', 'exchange_rate', 'payment_type', 'payer', 'receipt_number', 'accountant', 'accountant_amount', 'accountant_currency', 'payment_receiver', 'notes']
        labels = {
            'project': 'Proyecto',
            'date': 'Fecha de Pago',
            'type': 'Tipo',
